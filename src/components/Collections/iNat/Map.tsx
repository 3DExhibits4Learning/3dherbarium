...
export default function Map() {
	...
	const lightModeTiles: string =
		"https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}.png"
	const darkModeTiles: string =
		"https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}"
	const prefersDarkMode: boolean =
		window.matchMedia &&
		window.matchMedia("(prefers-color-scheme: dark)").matches
	const openAttribution: string =
		"&copy; https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
	const esriAttribution: string =
		"Powered by <a href='https://www.esri.com/en-us/home' rel='noopener noreferrer'>Esri</a>"
	const iNatTileUrl: string =
		"https://api.inaturalist.org/v1/points/{z}/{x}/{y}.png?photos=true&taxon_name=" +
		data.activeSpecies
	...
	return (
		<div className="relative h-full w-full">
			...
			<MapContainer
				className="z-0 rounded-xl h-full w-full"
											...
											<div className="flex h-[200px] w-[300px] justify-between !text-[#004C46]">
												<div className="flex flex-col justify-between text-old-growth-green">
													...
													<div className="h-[80%] flex flex-col justify-start mt-[8px] text-[#004C46] dark:text-white ">
														...
														<p className="text-[14px] !m-0 !mb-2">
															Date: {observation.observedDate}
														</p>
														<p className="text-[14px] !m-0 !mb-4">
															Verifiable: {observation.gradeType}
														</p>

														{/* <div className=""> <MessageButton userToMessage={observation.user.userName}/> </div> */}
													</div>
												</div>
												<a
													href={observationUrl + observation.id}
													target="_blank">
													<Image
