...
import { iNatLeadingUser, userPageUrl } from "@/functions/client/collections/iNat"
                 ...
                 {props.observers.map((observer, index) => (
                        <React.Fragment key={index}>
                            ...
                            <div className="flex justify-center items-center">  
                                <a id='herb-anchor' href={userPageUrl + observer.user.userName} 
        ...
        { props.identifiers &&
             <div className="bg-dune-grass dark:bg-[#212121] grid grid-cols-3 w-[95%] h-full my-4 rounded-lg">
                 ...
                 {props.identifiers.map((identifier, index) => (
                        <React.Fragment key={index}>
                            <div className="flex justify-center items-center">{index + 1}</div>
                            <div className="flex justify-center items-center"> <a id='herb-anchor' href={userPageUrl + identifier.user.userName} 
