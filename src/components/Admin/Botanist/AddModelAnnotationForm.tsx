...
// Main JSX
export default function AddModelAnnotationForm(props: { annotationModels: model[], baseUid: string, position: string | undefined }) {
    ...
    const enterAnnotationIntoDb = async () => dataTransferHandler(context.initializeDataTransferHandler, context.terminateDataTransferHandler, enterNewModelAnnotationIntoDb, [uid, props.baseUid, title, props.position as string, annotation], 'Adding model annotation')
            ...
            <section className="flex flex-col w-full border rounded-xl px-12 py-6">
                ...
                <section className="flex w-full">
                    <div className="flex flex-col w-3/5 max-w-[750px] mr-12">
                        ...
                        <ModelAnnotationSelect value={uid} setValue={setUid} modelAnnotations={props.annotationModels} />
