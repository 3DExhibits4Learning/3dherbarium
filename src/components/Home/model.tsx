...
// Typical imports
import { ChangeEvent, useEffect, useState, useRef, MutableRefObject, LegacyRef } from 'react'
    ...
    <article className='flex h-full'>
      ...
      <div id='sliderDiv' className='hidden overflow-x-auto lg:flex flex-col w-2/5 h-full pr-[4] bg-black items-center pt-[1%] text-white overflow-y-auto' style={{ transition: "width 1.5s", zIndex: "1" }}>
        ...
        <div className='grid h-1/2 grid-cols-1 grid-rows-3 fade'>
          ...
          <div ref={(el) => elementsRef.current['barkSection'] = el} id='barkSection' className='height-[15%] w-full'>
          ...
          <div ref={(el) => elementsRef.current['phloemSection'] = el} id='phloemSection' className='height-[15%] w-full opacity-0'>
          ...
          <div ref={(el) => elementsRef.current['xylemSection'] = el} id='xylemSection' className='height-[15%] w-full opacity-0'>
        ...
        <div className='w-full pt-[5%] text-center fade'>
          <input ref={slider as LegacyRef<HTMLInputElement>} id='opacitySlider' type='range' min='0' max='300' step='1' value={rangeValue} onChange={(e: ChangeEvent<HTMLInputElement>) => handleValueChange(e, setRangeValue)}></input><br></br><br></br>
